...
const Header = () => {
  ...
  const familyResources = [
    ...
    { name: "Family Addiction Answers", href: "/answers", highlight: true },
    { name: "Enabling Answer Center", href: "/enabling-answer-center", highlight: true },
    { name: "Addiction Family Glossary", href: "/glossary", highlight: true },
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="py-2">
                ...
                <div className="flex flex-col gap-2 pl-4">
                  ...
                  <Link to="/answers" className="text-primary hover:text-primary/80 transition-colors font-semibold" onClick={() => setIsMenuOpen(false)}>Family Addiction Answers</Link>
                  ...
                  <Link to="/glossary" className="text-primary hover:text-primary/80 transition-colors font-semibold" onClick={() => setIsMenuOpen(false)}>Addiction Family Glossary</Link>
