...
const results: Record<SeverityLevel, ResultData> = {
  none: {
    ...
    recommendations: [
      "Continue to maintain open, non-judgmental communication",
  ...
  mild: {
    ...
    recommendations: [
      ...
      "Suggest outpatient counseling or a substance abuse evaluation",
  ...
  moderate: {
    ...
    recommendations: [
      "Seek a professional substance abuse evaluation",
      "Consider Intensive Outpatient Programs (IOP) – structured treatment while living at home",
      "Partial Hospitalization Programs (PHP) may be appropriate for more structure",
      "Consult with a professional interventionist if they're resistant to help",
  ...
  severe: {
    ...
    recommendations: [
      "Seek immediate professional help – call a treatment center or addiction specialist",
      "If there's any risk of dangerous withdrawal (alcohol, benzodiazepines, opioids), medical detox is essential",
      "Residential/inpatient treatment is often the most effective option at this stage",
      "Consider a professional intervention with a certified interventionist",
      ...
      "Connect with Al-Anon or a family therapist for your own support",
