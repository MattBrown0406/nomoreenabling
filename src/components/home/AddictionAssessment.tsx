...
const results: Record<SeverityLevel, ResultData> = {
  none: {
    title: "Few Observed Indicators",
    dsmInterpretation: "Your responses show few of the patterns included in this educational questionnaire. This does not rule out a substance use disorder or replace professional assessment.",
    description: "If you remain concerned, document what you are seeing and ask a qualified healthcare professional for guidance.",
    recommendations: [
  ...
  mild: {
    title: "Some Concerning Indicators",
    dsmInterpretation: "Your responses show several patterns that clinicians may explore during a formal substance use assessment. This questionnaire cannot diagnose or assign severity.",
    description: "A calm conversation and professional evaluation can help clarify what is happening and what support is appropriate.",
    recommendations: [
      "Ask a qualified addiction professional to assess needs and recommend an appropriate level of care",
    ...
    urgency: "Consider a professional evaluation and family guidance",
  },
  moderate: {
    title: "Several Concerning Indicators",
    dsmInterpretation: "Your responses show multiple patterns that warrant assessment by a qualified addiction or healthcare professional. This result is not a diagnosis or severity rating.",
    description: "The reported behaviors may be causing meaningful harm. Professional assessment can clarify safety, withdrawal risk, and appropriate support.",
    recommendations: [
      "Contact a qualified addiction professional for a complete evaluation and level-of-care recommendation",
      "Ask about medical, outpatient, or residential options only after an individualized assessment",
    ...
    urgency: "Prompt professional assessment is appropriate",
  },
  severe: {
    title: "Many High-Risk Indicators",
    dsmInterpretation: "Your responses show many serious warning patterns. Only a qualified clinician can diagnose a substance use disorder, assess dependence, or determine severity.",
    description: "Some reported patterns may involve urgent medical or safety risk. Seek qualified professional assessment rather than relying on this questionnaire alone.",
    recommendations: [
      "Contact a qualified addiction or healthcare professional promptly for an individualized assessment",
      "If alcohol, benzodiazepine, or opioid withdrawal may be involved, seek medical advice before anyone tries to stop abruptly",
    ...
    urgency: "Prompt professional help is warranted; use 911 for immediate danger or medical emergency",
  },
};
