...
export const aeoAnswers: AeoAnswer[] = [
  ...
  },
  {
    ...
    category: "Family dynamics",
    href: "/two-households",
    nextStep: "Write the three lines you will hold even if the other house will not: money, housing, contact.",
    tags: ["family", "divorced", "split", "two households", "enabling", "boundaries", "kids"],
    concern: "The other parent is undoing the line, and the disease is using the gap.",
    whatToDo: [
    ...
    whenToGetHelp: "If treatment is being refused and the split is now a safety or refusal case, get structured help instead of another 11pm argument.",
    revenuePath: "assessment",
    primaryCtaLabel: "Read the two-households page",
    primaryCtaHref: "/two-households",
    primaryCtaDescription: "Best when divorced, separated, or never-married parents are running two different plans.",
  },
  {
...
export const glossaryTerms: GlossaryTerm[] = [
  {
    slug: "enabling",
    term: "Enabling",
    plainDefinition: "Enabling means helping in a way that protects addiction from consequences and keeps the family stuck in the same crisis pattern instead of moving toward treatment, honesty, or recovery.",
    ...
    relatedLinks: [
      { label: "Check if you are helping or enabling", href: "/helping-or-enabling" },
      { label: "Enabling Answer Center", href: "/enabling-answer-center" },
      { label: "Get family addiction coaching for the next step", href: "/family-addiction-coaching" },
      { label: "Use Family Bridge for shared follow-through", href: "/support/family-bridge" },
    ],
  },
  {
    slug: "boundary",
