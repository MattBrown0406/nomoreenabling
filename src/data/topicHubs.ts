...
export const topicHubs: TopicHub[] = [
  ...
  },
  {
    ...
    featuredSlugs: [
      ...
      "what-to-say-in-addiction-intervention",
    ...
    guideSections: [
      ...
      },
      {
        ...
        body: "The core cluster now walks families through planning, language, letters, alcoholism-specific intervention, and the after-intervention handoff. From here, the funnel should route high-intent readers toward private guidance, Freedom Interventions, and treatment navigation.",
      },
    ],
  },
  {
    slug: "alcoholic-family-member",
    title: "Alcoholic family member: what families can do when drinking runs the home",
    shortTitle: "Alcoholic Family Member",
    description: "A practical hub for families dealing with alcoholism, denial, high-functioning drinking, child safety, and alcohol-specific enabling.",
    intro: "This hub is for spouses, parents, adult children, and relatives trying to understand when alcohol has moved from a private habit into a family system.",
    bestFor: "Best when alcohol is legal, normalized, or hidden behind functioning, but the family is still being harmed.",
    categories: ["Alcoholic Family Member", "Addiction", "Boundaries", "Family Support"],
    featuredSlugs: [
      "how-to-help-an-alcoholic-who-doesnt-want-help",
      "how-to-stop-enabling-an-alcoholic",
      "high-functioning-alcoholic-family-signs",
      "alcoholic-parent-boundaries",
      "drinking-around-kids-unsafe",
    ],
    primaryCta: { label: "Take the helping vs enabling assessment", href: "/helping-or-enabling" },
    secondaryCta: { label: "Request guidance from Matt", href: "/work-with-matt" },
    searchIntent: "Families searching for help with an alcoholic spouse, parent, adult child, or high-functioning drinker who denies the problem or refuses treatment.",
    sponsorCategory: "Alcohol treatment programs, family recovery education, outpatient care, detox assessment, intervention services, and family coaching.",
    keyQuestions: [
    ...
    guideSections: [
      {
        heading: "Alcohol often hides in plain sight",
        body: "Alcohol is legal, social, and easy to normalize. Families may wait too long because the person still works, pays bills, or appears fine in public. This hub helps readers focus on impact, safety, and repeated harm instead of arguing over whether the label fits.",
      },
      {
        heading: "Why this cluster matters for search",
        body: "Alcohol-related family searches are one of the largest addiction search surfaces. They bring in spouses, adult children, parents, and relatives who may not yet know whether treatment, intervention, boundaries, or support groups are the right next step.",
      },
      {
        heading: "The path this hub should create",
        body: "The reading path starts with denial and refusal, moves into enabling and high-functioning signs, then addresses parenting and child safety. That creates natural routing into Sober Helpline, the boundaries course, Freedom Interventions, and alcohol treatment sponsors.",
      },
    ],
  },
  {
    slug: "crisis-and-safety",
    title: "Crisis and safety: what families should do when addiction becomes dangerous",
    shortTitle: "Crisis and Safety",
    description: "Safety-first guidance for families facing unsafe homes, drug use in the house, theft, threats, violence, impaired driving, or crisis uncertainty.",
    intro: "This hub is for families who are no longer dealing only with worry. Something about the home, the behavior, or the risk level has become unsafe.",
    bestFor: "Best when you need to know what to do first, who to call, and how to stop treating danger like a normal family conflict.",
    categories: ["Crisis and Safety", "Family Support", "Boundaries", "Intervention"],
    featuredSlugs: [
      "addiction-makes-home-unsafe",
      "loved-one-using-drugs-in-my-house",
      "addicted-loved-one-stealing-from-you",
      "addiction-threats-violence-home",
      "when-to-call-911-crisis-line-treatment-interventionist",
    ],
    primaryCta: { label: "Request guidance from Matt", href: "/work-with-matt" },
    secondaryCta: { label: "Read intervention guidance", href: "/topic-hubs/intervention" },
    searchIntent: "Families searching during urgent addiction-related situations involving unsafe housing, theft, threats, violence, drug use in the home, overdose risk, or uncertainty about who to call.",
    sponsorCategory: "Crisis support, intervention services, treatment navigation, family safety resources, detox, and recovery support.",
    keyQuestions: [
    ...
    guideSections: [
      {
        heading: "Safety comes before persuasion",
        body: "Families often try to talk their way through situations that have already become dangerous. This hub makes the first question clearer: is anyone in immediate danger? If so, the next step is emergency or crisis support, not another family debate.",
      },
      {
        heading: "Why this cluster matters for search",
        body: "Crisis searches are high urgency and high trust. These readers may be looking for help at midnight, after theft, after threats, or after discovering drug use at home. Clear guidance builds credibility and routes people to the right level of help.",
      },
      {
        heading: "The path this hub should create",
        body: "The reading path moves from unsafe home recognition into specific scenarios, then to the decision about who to call. The business path should be careful: emergencies go to emergency help; non-emergency but escalating family systems route to Sober Helpline, Matt, or Freedom Interventions.",
      },
    ],
  },
  {
