...
const staticPages: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: "/alcohol-intervention-help", priority: "0.95", changefreq: "monthly" },
  { path: "/what-to-do-when-they-refuse-treatment", priority: "0.95", changefreq: "monthly" },
  { path: "/family-addiction-consultation", priority: "0.95", changefreq: "monthly" },
